...
#speaker("Sangha 1", [
  Hello? Okay audible. When I do that exercise and there is one major thought...
])

#speaker("Dawai", [
  We're still in the exercise right now? 
])

#speaker("Sangha 1", [
  Yes. Oh, I mean, I'm speaking now so there's more thoughts. 
])

#speaker("Dawai", [
  No, doesn't have to be any thoughts as we're speaking. You can still have "the weather is cold" here as your only thought. So let's keep "the weather is cold" as our thought. Now what are you saying about that thought? 
...
#speaker("Sangha 1", [
  It does seem I can feel that. 
])

#speaker("Dawai", [
  Where it is intuitively. Okay? Don't use that powerful mind of yours, but intuitively check in when you have a mono thought, just one thought: "The weather is cold." Where is that thought happening? Intuitively. 
])
...
#speaker("Dawai", [
  Hum. Sure. Is there a knowingness there? 
])
...
#speaker("Dawai", [
  As we say, as we say, "the weather is cold." There's a knowingness there too, isn't there? 
])
...
#speaker("Dawai", [
  So it's happening in an environment which is basically space. And there's also a knowingness infused with that. So we have Dharmakaya and Sambhogakaya there, right? Empty cognition. 
])
...
#speaker("Sangha 1", [
  Okay, okay. I feel it now. Okay. Since I felt some sensations and like feelings and kind of mood, I thought that was not facilitating that. 
])

#speaker("Dawai", [
  Yeah, that's just more add-ons, right? That's adding... like I said, become mono-minded, but there may be more stuff going on as you're doing this little experiment. 
])
...
#speaker("Dawai", [
  Anybody else not able to isolate a thought?
])

#speaker("Sangha 2 (chat)", [
  This seems somewhat similar to focusing on a mantra or recitation.
])

#speaker("Dawai", [
  Somewhat similar, I would say, but this is more scientific. This is actual introspection because with a mantra you're just chanting, chanting, chanting. But here you're actually turning awareness into a kind of scope, a microscope, telescope, whatever, mental scope. And you're using that scope, that ability for visibility to look into your own mind and just witness what's going on there. And then lucky for us, the witnessing itself is good enough, a remedy. So just being able to see your thought from start to finish particularly is very powerful.
...
#speaker("Sangha 3 (chat)", [
  How does Avalokiteshvara do the belly and hand with a thousand arms?
])
...
#speaker("Sangha 6 (chat)", [
  Isolating the conditioned self.
])

#speaker("Dawai", [
  Yeah, Sangha 6 got it, because that's another kind of thought, but it's a little bit more vague and in the body.
])

#speaker("Sangha 6 (chat)", [
  In my experience of the exercise, keeping the thought in my mind and continually causing it to rise, or it would otherwise dissolve.
])
...
#speaker("Dawai", [
  ...
  But this is a great question. Samatha and Vipassana are never separated in this Dzogchen approach. So when you stabilize an awareness itself, that allows you to isolate a thought. The more a Samatha you have, essentially, the more you can isolate that thought, the better you will be at it. So if the mind is very non-discursive, I'm sitting here space-like and I just invoke a thought, birds are flying. then it's very easy to stay here because of Samatha. 
...
#speaker("Sangha 6", [
  Don't know if I see that second bit about the holding the thought is the compassion.
])
...
#speaker("Dawai", [
  ...
  And... Yeah, what did you say here?
])

#speaker("Sangha 8 (chat)", [
  It went separate in Shakyamuni Buddha's introductions.
])

#speaker("Dawai", [
  I think he was keeping them together too. I think it was separate further down the road, but I'm not sure. Yeah, go ahead. 
])
