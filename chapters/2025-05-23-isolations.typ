...
#speaker("Sangha 1", [
  Do you feel that the fact that nothing specific observes that which is also not something is the essence of emptiness?
])
...
#speaker("Sangha 2", [
  Why don't we want bad moods to leave?
])

#speaker("Dawai", [
There could be many answers for that, actually, that are probably better than what I could give because there are lots of studies on negative bias, why we lean into negativity. It's a very curious thing. I think it has to do with survival and the four F's of psychology of the reptilian mind and of our karmic conditioning.
...
So you know, you can inject that into your ego if you want to, but it's more to just let you know how special it is when we connect with Dzogchen, at least according to the dharma texts. Yes, and then Yeshé has here the Kali Yuga cycle. And by the way, what does 4,320,000 equal? 9. Okay, very good.
...
#speaker("Sangha 4", [
  I want to ask, since this was a very broad and beneficial overview in my opinion, but I want to say, where do the mental factors get into, like, fit into this? Because it said that they kind of observe what the minds observe, the aspects of the minds observe, but other than that, I don't really know how they correlate to these, so I want to ask.
])

#speaker("Dawai", [
  Listen, go ahead and copy and paste the 52, I think it is, mental factors. So, you see how that was a very generalized question, right?
])

#speaker("Sangha 4", [
  Yeah, since we kind of did a broad overview as well, I wanted to ask a broad question to that, if that's okay.
])
...
#speaker("Sangha 4", [
  No yeah, okay, that makes sense. I must [audio cutting] the concept of mental formations, I think, because are they separate from the minds, or are they kind of in the concept?
])

#speaker("Dawai", [
  My friend, you're just asking questions just to ask questions now. Yeah, really, what does your heart desire, right now?
])

#speaker("Sangha 4", [
  What does my heart desire? I think I was just confused about that, but that's okay.
])
...
#speaker("Sangha 4", [
  No, I think that makes sense. Okay, yeah, I can kind of see it now when it's described like that. I think I was kind of not understanding the meaning of the formations, but yeah, that fits in the way you talked of it. That's okay.
])
...
#speaker("Sangha 4", [
  Well, thank you, yes. I think that's a very good benefit of this group, and for, like, socially too since we don't need to be lecturing each other constantly if we want to fix anything, and there is a trust that it will kind of be fixed by itself, I suppose. And I think that's very socially awesome, I guess, socially awesome.
])

#speaker("Dawai", [I imagine they would be a great teacher too, huh? Maybe. Further down the line.])

#speaker("Sangha 4", [Thank you, thank you.])
