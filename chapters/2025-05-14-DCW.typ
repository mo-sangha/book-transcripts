...
Dawai: Isn't that ironic, everybody see the synchronicity? Whats the syncronicity? [laughing] Yeah. Isn't that crazy? Yeah, that's just like superficial synchronicities, but it's fun to see them, because then these are multilayered. 
...
Dawai: Yeah, so what do you see when you see a hand? You see essentially an aggregate within empty space kind of stuck together by electricity. Very nice. Yes—mind is there, we can verify that, that's the one thing we can verify, right? And it goes on:
...
Dawai: And remember this is an older text, particles now are divided into like quantum fields—it's just movement, it's not even anything there. And it says:
...
Dawai: Or in Judeo Christianity—Yeshua, or whatever terms you want to have for God. By the way, Brahma, Shiva, and Vishnu are personifications of the mind. They're meant to represent aspects of your own mind, just like The Kunjed Gyalpo, but they have been externalized and turned into external deities, disempowering the practitioners.
...
#archive_minimal("May 14, 2025", "Distinguishing Consciousness...", "https://www.youtube.com/watch?v=zOaS2dQeugM&t=745s")
