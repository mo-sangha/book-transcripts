...
So if a fish was made out of pure water, it would still have its own mind, but it wouldn't be inseparable from the ocean. So many different, different ways to sort of um..

Responding to chat: Oh good, you know, I'm glad that's happening for you. Because you know, it's the first time I use some of these metaphors and things like that to describe what I believe is correlating with the Dzogchen teachings and some of the other teachings out there. And what I see and what I believe from the other yogis are seeing, okay? In the best way to explain that. 

And how you can end up melting into this grand divinity, and that's what they call unionizing, right? Unionizing the Higher Self or unionizing with God, unionizing with the infinite consciousness. Now your body, speech, and mind is in a great flow. 
...
Sangha 1: Wonderful teaching. Thank you. I heard it, you know, when the gods in Hindu religion, Brahma, and he was also explaining the same thing and a lot of regards freaked out. Anyway, that's not what I want to ask you. 
...
Dawai: Yeah, we can. Do you want to do today?

Sangha 1: Yes, please.

Dawai: We can do towards the end after this section of the session, okay? And those of you who want to stay for the sadhana, you're welcome to. And those of you who aren't really into mantras and things like that, you can check out. But I would do the Guru Rinpoche sadhana. Yeshé you can find it in a Namchö text, by the way.

(Reading chat / Sangha 2): How would a fish made of water proclaim ownership of some part of the water as mine, without it not being sensible?

Dawai: Well that's what we do, we take.. If this is all cognizance, a pure base of infinite cognition, and let's say you're just resting in that, purely happy. Then somebody offers you an apple [laughing], that's a reference to Adam and Eve, you have to be super corny to get that one, but um, so really… 
...
But because it's cognizance, just like the mind can dream and layer itself and isolate itself, all of a sudden you create a world. Ehh I don't like this pure cognizance, I want to eat some broccoli, and I want to actually take somebody else's broccoli, right? 

So now you create a separation within that. Before, you were completely submerged in the bathwater. Now, you're sort of sticking your head out of the bath and it's creating a separability. So self and other is how dependent origination started, that's how the whole issue gets started: is you divide cognizance within cognizance. I don't know if any of this is making sense, but I'm trying to just explain it—how that initiates that self and another.

Maybe look at a single-cell organism, to me, that was a great example of how consciousness can separate itself out, right? Making sense, or no? How consciousness can separate itself out and isolate like a cloud within the sky? A cloud can separate itself from the sky, yet it's inseparable from the sky, isn't it? 

Okay, now I should have started with the cloud.

Reading chat of Sangha 3: Someone was talking about how yogis can go without food, this practice called chölen?

Dawai: Yeah, they can. I think that's possible, but maybe unnecessary.

Sangha 3: In that video, yeah, they told you that some yogis are lying down for a month after month so, and that the call is the samadhi state, they are all in a samadhi state. They are in, it’s like, I can't explain. We have to rewatch that video again if we need to. Yeshé has posted the link. 
...
Dawai: And you have energy even if you're thinking—you're thinking from awareness now, so it's not going to consume all that energy. Thoughts are able to flow, big different. You can tell when you're crunching on thoughts, when you're holding thoughts, and this can, especially if you have brain sensitivity, can be really obvious. So that's what's taking energy, is when you're holding thoughts and being in that cycle of thoughts. Now very good, thank you.

Sangha 3: Thank you all for answering my questions. Thank you.

Dawai: Thank you. Yeah someone else want to jump in there?

Sangha 5: Sure. Good morning. The concentric clear films metaphor was great. It reminded me of there's a book, Holographic Mind, Holographic Universe, and I don't remember much of it, but I remember the description of holographic film, which is this: 

You pass light through the film at a certain angle and it creates an interference pattern, and if you look at the film, you can't see—like if you just hold it up to the light, you can't see what the picture was, but if you pass light through it at the same angle, there's the picture. And then the really interesting piece of it, to me, was if you cut a small corner off of the film, not from the center but from the corner or from anywhere, it contains the whole picture in that little piece of the film. Yeah, and that is the part that reminded me of your concentric clear films, which is—
...
Dawai: [laughing] Yes, an omnipresence is also synonymous, correlates with empathy and compassion. Omniscience correlates with compassion. The deeper empathy and compassion you have, the more apparent our natural telepathy and clairvoyance will be.
...
So I encourage you all to allow empathy and compassion, which is — that's the essence of the Mahayana path, okay? Because they emphasize bodhicitta and the bodhisattva yana as it’s called. And so that's an introduction to non-duality, emptiness, and this omniscience and omnipresent clear cognizance. 

Okay, very nice, very good.

So these are exciting topics that don't get explored very often, at least not out there in the known Dharma world, at least that I know of anyway—how to correlate things like super-cognitions with sensitivity. Today has been this, one of many wonderful themes happening today, actually. So part of that theme, part of our discussion has been wholeness, the fourth samaya of oneness, that I imagine we're getting to in the Longchenpa text. It's oneness without melting into oneness so it's not a complete loss of agency in the conventional sense of the word. 

Okay, very nice. Any other comments going on?

Reading chat: Interesting. Yoga Nidra actually sort of got me into Dharma.

Dawai: Okay, very good.



#archive_minimal("May 15, 2025", "The great canvas...", "https://www.youtube.com/watch?v=m6pNsRWdSKo")
