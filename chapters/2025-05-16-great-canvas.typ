...
So if a fish was made out of pure water, it would still have its own mind, but it wouldn't be inseparable from the ocean. Wow, so many different, different ways to sort of um..

#btw[Dawai reads a chat message]. Oh good, I'm glad that's happening for you. Because you know, it's the first time I use some of these metaphors and things like that to describe what I believe is correlating with the Dzogchen teachings and some of the other teachings out there. And what I see and what I believe from the other yogis are seeing, okay? In the best way to explain that.
...
#speaker("Dawai", [
  Yeah, we can. Do you want to do it today?
])
...
#speaker("Dawai", [
  We can do it towards the end after this section of the session, okay? And those of you who want to stay for the sadhana, you're welcome to. And those of you who aren't really into mantras and things like that, you can check out. But we'll do the Guru Rinpoche sadhana. Yeshé, you can find it in a Namchö text, by the way.
])

#speaker("Sangha 2 (chat)", [
  How would a fish made of water proclaim ownership of some part of the water as mine, without it not being sensible?
])
...
#speaker("Sangha 3 (chat)", [
  Someone was talking about how yogis can go without food, this practice called chölen?
])

#speaker("Dawai", [
  Yeah, they can. I think that's possible, but maybe unnecessary.
])

#speaker("Sangha 3", [
  In that video, yeah, they told you that some yogis are lying down for a month after month so, and that the call is the samadhi state, they are all in a samadhi state. They are in, it's like, I can't explain. We have to rewatch that video again if we need to. Yeshé has posted the link.
...
#speaker("Sangha 3", [
  Another follow-up question would be: Yeshé once told me when I was having difficulty, he was telling me how to have a good sleep without sleeping. So he taught me yoga nidra and I came to know that yoga nidra is nothing but resting in awareness. You are just opening, you can close your eyes, you can keep your eyes open, doesn't matter. You are just staying in awareness and you are not in thinking mind. You are not losing your glucose, sucrose, you are in a rest state...
])
...
#speaker("Sangha 4", [
  Yeah, yoga nidra is a preliminary. In hatha yoga practices, and the ones I've been involved in, we do yoga nidra at different sections and there's times where you do it multiple times. And it takes you deeper and deeper in each sit. What's happening is it's allowing the body to go in deeper, deeper states of relaxation to where you no longer feel your body. You get very expansive from that, then your mind can then relax.
...
#speaker("Dawai", [
  And you have energy even if you're thinking---you're thinking from awareness now, so it's not going to consume all that energy. Thoughts are able to flow, big difference. You can tell when you're crunching on thoughts, when you're holding thoughts, and this can, especially if you have brain sensitivity, can be really obvious. So that's what's taking energy, is when you're holding thoughts and being in that cycle of thoughts. Yeah, very good, thank you.
])

#speaker("Sangha 3", [
  Thank you all for answering my questions. Thank you.
])

#speaker("Dawai", [
  Thank you. Yeah someone else want to jump in there?
])

#speaker("Sangha 5", [
  Sure. Good morning. The concentric clear films metaphor was great. It reminded me of there's a book, Holographic Mind, Holographic Universe, and I don't remember much of it, but I remember the description of holographic film, which is this:
  ...
  And you also used that, you said today that omnipresence is the same as non-referential---that kind of blew my mind.
...
#speaker("Dawai", [
  ...
  This is very easy too---just one little bug, or just saying some kind things and listening to a friend, anything like that to get out of the selfing, self self self self self. That's why this group is so great too, we get a chance to do that.
