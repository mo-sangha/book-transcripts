...
Dawai: Or basis would be a lot better of a word there, because ground implies some type of substantiality. So,if there is no distraction based on activities or sense indulgences (sense attractions, that is the [basis] of the blissful dharmatā.
...
>8.3.3.2.2.2.1.3 Awareness Subsumed as the Great Evenness of Total Liberation
...
>In the Reverberation of Sound Tantra, it tells us:
...
Dawai: Ah wisdom / beingness. They stick that way, it's good because they're agreeing on it. I've seen that by Richard Barron and several other translators are okay with that intent, but still.
...
Dawai: Oh goodness, this is like dousing myself in sweet nectar right now. Just five words—secret to life. This liberation occurs upon itself. You don't have to do anything. Yeah, I feel like I'm taking a shower, which I don't do very often. Okay, so it says here:
...
Concepts and fixations ––confused mind.
...
Since the wisdom [beingness] of emptiness [or suchness of emptiness] is cognitively perfected, the many enumerations are completely exhausted.
